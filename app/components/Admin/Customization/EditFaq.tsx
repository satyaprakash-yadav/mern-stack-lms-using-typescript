  ...
  return (
    <>
      {isLoading ? (
        ...
        <div className="w-[90%] h-[110vh] 800px:w-[80%] m-auto mt-[120px]">
          <div className="mt-12">
                  ...
                  <dt className="text-lg">
                    ...
                    >
                      ...
                      <span className="ml-6 flex-shrink-0">
                        {q.active ? (
                          <HiMinus className="h-6 w-6 mt-5" />
                        ) : (
                          <HiPlus className="h-6 w-6 mt-5" />
                        )}
                      </span>
                    </button>
                  </dt>
            ...
            <IoMdAddCircleOutline
              className="dark:text-white text-black text-[25px] cursor-pointer mb-10"
      ...
      !rounded absolute bottom-12 right-12 h-[100px]`}
            onClick={
              areQuestionsUnchanged(data.layout.faq, questions) ||
              isAnyQuestionEmpty(questions)
                ? () => null
