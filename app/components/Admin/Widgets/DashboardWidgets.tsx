      ...
      <div className="grid " style={{ gridTemplateColumns: "75% 25%" }}>
        ...
        <div className="pt-[80px] pr-8">
          <div className="w-full dark:bg-[#111C43] rounded-sm shadow">
            <div className="flex items-center p-5 justify-between 800px:h-[20vh]">
              <div className="">
                <BiBorderLeft className="dark:text-[#45CBA0] text-[#000] text-[30px] 800px:text-[30px] 800px:mt-2" />
                <h5 className="pt-2 font-Poppins dark:text-[#fff] text-black text-[20px] 800px:text-[15px]">
                  {ordersComparePercentage?.currentMonth}
                </h5>
                <h5 className="py-2 font-Poppins dark:text-[#45CBA0] text-black text-[20px] font-[400] 800px:text-[13px]">
                  Sales Obtained
                </h5>
              </div>
              <div>
          ...
          <div className="w-full dark:bg-[#111C43] rounded-sm shadow my-8">
            <div className="flex items-center p-5 justify-between 800px:h-[20vh]">
              <div className="">
                <PiUsersFourLight className="dark:text-[#45CBA0] text-[#000] text-[30px] 800px:text-[30px] 800px:mt-2" />
                <h5 className="pt-2 font-Poppins dark:text-[#fff] text-black text-[20px] 800px:text-[15px]">
                  {userComparePercentage?.currentMonth}
                </h5>
                <h5 className="py-2 font-Poppins dark:text-[#45CBA0] text-[#000] text-[20px] font-[400] 800px:text-[13px]">
                  New Users
                </h5>
              </div>
              <div>
