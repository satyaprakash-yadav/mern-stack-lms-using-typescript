  ...
  return (
    <div className="text-black dark:text-white">
      ...
      <h1 className={`${styles.title} 800px:!text-[45px]`}>
        What is <span className="text-gradient">SARSOLUTIONZ ELearning?</span>
      </h1>
      <br />
      <div className="w-[95%] 800px:w-[85%] m-auto">
        <p className="text-[18px] font-Poppins">
          Are you ready to take your programming skills to the next level? Look
          no further than <span className="text-gradient">SARSOLUTIONZ</span>, the premier programming community
          dedicated to helping new programmers achieve thier goals and reach
        ...
        <br />
        <span className="font-Josefin text-[22px]">
          SATYAPRAKASH YADAV AND TEAM -
        </span>
        <h5 className="text-[18px] font-Poppins">
          Founder and CEO of <span className="text-gradient">SARSOLUTIONZ</span>
        </h5>
        <br />
        <br />
        <br />
